...
namespace lve {
    ...
    void FirstApp::createPipelineLayout() {
        ...
        if(vkCreatePipelineLayout(lveDevice.device(), &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) [[unlikely]] {
    ...
    void FirstApp::createCommandBuffers() {
        ...
        if(vkAllocateCommandBuffers(lveDevice.device(), &allocInfo, commandBuffers.data()) != VK_SUCCESS) [[unlikely]] {
        ...
        for(size_t i = 0; i < commandBuffers.size(); i++) {
            ...
            if(vkBeginCommandBuffer(commandBuffers[i], &beginInfo) != VK_SUCCESS) [[unlikely]] {
